...
1. **Add response models** to `src/mcp_slack/api_models.py`
2. **Add client methods** to `src/mcp_slack/api_client.py`
3. **Add the tool** to `src/mcp_slack/server.py` using `@mcp.tool()`
